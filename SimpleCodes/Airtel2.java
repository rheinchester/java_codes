...
public class Airtel2{
	public static void main(String[] args) {
	 ...
	 switch(userDial){
						...
						case "1":{
							...
							switch(b){
								...
								case "4":{
									...
									System.out.println("would you like to continue, if not press 1 to exit ");
			...
			// 		System.out.println("10mb for N100");
			// 		System.out.println("30mb for 300");
			// 		System.out.println("40mb for 400");
			// 		System.out.println("50mb for 500");